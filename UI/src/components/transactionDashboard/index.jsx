...
import {monthsData, apiStatusConstant}  from './monthdata';

const imageUrl="https://lh3.googleusercontent.com/p/AF1QipNqB9Y9fBHxJKflwdjliy2tqb9sDURiEaRloqgz=s1360-w1360-h1020";
...
class TransactionDashboard extends Component {
  ...
  getTransactionData = async () => {
    try {
      ...
      //   `${URL_API}/Product?month=${selectedMonth}&search_q=${searchText}&page=${pageNo}`
      // );
  ...
  getStatisticsData = async () => {
    try {
      ...
      const response = await axios.get(
      `${URL_API}/CombinedAPIresult?month=${selectedMonth}`);
      const data = await response.data;
...
// return (<div className='transactiondashboardcontainer'>
//        <Header im={imageUrl}/>
